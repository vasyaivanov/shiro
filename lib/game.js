...
Game.prototype.init = function Game_init(callback)
{
  ...
  level(this._storage, {keyEncoding: 'utf8', valueEncoding: 'json'}, function(err, db)
  {
    ...
    // connect to redis db and get stuff
    ...
    // console.log("JD: redis="+redis);
    // this._redis.set("student1","value1", function (err, reply) {
      
    //   console.log("JD: write reply="+reply);
      
    //   this._redis.get("student1", function(err, reply){
    //     console.log("JD: read reply="+reply);
    //   });

    //   this._redis.keys("*", function(err, rows){
    //     console.log("JD: rows=" + rows)
    //   });

    // });
    // this._redis.get("student1", function(err, reply){
    //     console.log("JD: read outside reply="+reply);
    // });
