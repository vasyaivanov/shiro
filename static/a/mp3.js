...
// $( function() {
//     $( ".mp3_stop" ).click( function( event ) {
//       alert("JD: mp3 stop was clicked");
//         // websockets
//       this.socket = globalOptions.transport;
//       _game.socket.write({ 'mp3:pause':'pause' });
  ...
  this.socket = options.transport;
    ...
    $( ".mp3_stop" ).click( function( event ) {
      alert("JD: mp3 stop was clicked");
        // websockets
      this.socket = options.transport;
      this.socket.write({ 'mp3':'pause' });
      event.preventDefault();
    } );

    $( ".mp3_play" ).click( function( event ) {
      alert("JD: mp3 play was clicked");
        // websockets
      this.socket = options.transport;
      this.socket.write({ 'mp3':'play' });
      event.preventDefault();
    } );
...
this.socket.on('mp3', function mp3_Player(data)
  {
      alert("JD: recieved command to Pause mp3player");
